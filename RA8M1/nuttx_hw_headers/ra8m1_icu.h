...
#define R_ICU_SWIRQ_S_OFFSET               0x0010  /* Software Interrupt Request Register for Secure Interrupt (8-bits) */
#define R_ICU_SWIRQ_NS_OFFSET              0x0020  /* Software Interrupt Request Register for Non-secure Interrupt (8-bits) */
#define R_ICU_IENMIER_OFFSET               0x0060  /* Integrated Error NMI Interrupt Enable Registe for CPU (16-bits) */
#define R_ICU_NMIER_OFFSET                 0x0100  /* Non-Maskable Interrupt Enable Register (16-bits) */
...
#define R_ICU_WUPEN0_OFFSET                0x01a0  /* Wake Up Interrupt Enable Register 0 (32-bits) */
#define R_ICU_WUPEN1_OFFSET                0x01a4  /* Wake Up Interrupt Enable Register 1 (32-bits) */
#define R_ICU_SELSR0_OFFSET                0x0200  /* SYS Event Link Setting Register (16-bits) */
#define R_ICU_IELSR_OFFSET                 0x0300  /* ICU Event Link Setting Register %s (32-bits) */
...
/* Integrated Error NMI Interrupt Enable Registe for CPU (16-bits) ***********/
